/** Cosmetics Fishstick treated as “exclusives” (founders, platform, promos…). */
export const LOCKER_EXCLUSIVE_IDS = new Set(
  [
...
export function isLockerExclusiveId(cosmeticId: string): boolean {
  return LOCKER_EXCLUSIVE_IDS.has(cosmeticId.toLowerCase());
}
