...
<Sheet.Root bind:open>
  <Sheet.Content class="flex gap-0 sm:max-w-md">
    <Sheet.Header class="border-b border-border/60 px-4 py-3">
      <Sheet.Title>{$t('stwMissionAlerts.filters.title')}</Sheet.Title>
    </Sheet.Header>

    <div class="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto p-4">
      <div class="flex flex-col gap-2">
        <h2 class="text-sm font-medium">{$t('stwMissionAlerts.filters.zone')}</h2>
      ...
      <div class="flex flex-col gap-2">
        <div class="flex items-center justify-between gap-2">
          <h2 class="text-sm font-medium">{$t('stwMissionAlerts.filters.missionType')}</h2>
          <Label>
      ...
      <div class="flex flex-col gap-2">
        <h2 class="text-sm font-medium">{$t('stwMissionAlerts.filters.rarity')}</h2>
        <div class="flex flex-wrap gap-2">
      ...
      <div class="flex flex-col gap-2">
        <h2 class="text-sm font-medium">{$t('stwMissionAlerts.filters.rewards')}</h2>
        <div class="flex flex-wrap gap-2">
    ...
    <Sheet.Footer class="mt-0 border-t border-border/60">
