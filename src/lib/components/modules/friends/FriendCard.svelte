...
<div class="flex min-w-0 items-center rounded-md border border-border/70 bg-card/50 px-4 py-3">
  <div class="flex items-center gap-2">
    ...
    <div class="flex min-w-0 flex-1 flex-col">
      <span class="truncate text-sm font-medium">{friend.displayName}</span>
      {#if presence?.status}
