...
<p align="center">
  <a href="https://github.com/luanwolf/DozamigosLauncher/releases/latest"><img alt="Versão" src="https://img.shields.io/badge/vers%C3%A3o-0.2.0-a855f7"></a>
...
| Elementais | Novos da v42.10 (Raio X, Onigiri, Mega Man, Sobrescudo); extraído/dominado/nível via IDs Epic no fluxo Magpie/athena; ordem raro→mítico, coroa nos dominados, variantes Base/Dourado/Trapaceiro/Hacker de Saque, fundo alinhado à loja e exportação do álbum |
...
- Ferramentas extras: **Recursos** (grade, PL da conta, busca e exportação em imagem) e Boosts de XP.
...
- Jogos grátis da Epic (resgatar abre a página no Epic Games Launcher) e promoções com 100% de desconto na Steam, com aviso opcional.
- Cache horário dos dados gerais (elementais, vestiário, jogos grátis…); loja e lhamas seguem os crons próprios.
...
- **Versão instalada:** aparece abaixo do ícone do GitHub na barra lateral (`v0.2.0` nesta release).
